					...
					<div className="col-span-1 grid grid-cols-4 gap-5 md:col-span-4 lg:col-span-3">
						<div className="col-span-full md:col-span-2 lg:col-span-1">
							...
							<ul className="flex flex-col gap-1 text-slate-700 dark:text-neutral-300">
								<li>
									<a href="https://discord.gg/cyberwoxacademy" className="hover:underline">
										Contact us
									</a>
								</li>
							</ul>
						...
						<div className="col-span-full md:col-span-2 lg:col-span-1">
							...
							<ul className="flex flex-col gap-1 text-slate-700 dark:text-neutral-300">
								<li>
									<a href="https://courses.cyberwoxacademy.com" className="hover:underline">
										Courses
									</a>
								</li>
							</ul>
						...
						<div className="col-span-1">
							...
							<ul className="flex flex-col gap-1 text-slate-700 dark:text-neutral-300">
								<li>
									<a href="https://www.youtube.com/@cyberwoxacademy" className="hover:underline">
										Youtube
									</a>
								</li>
								{/* <li>
								...
								<li>
									<a href="https://cyberwoxacademy.com/about-us" className="hover:underline">
										About us
									</a>
								</li>
							</ul>
