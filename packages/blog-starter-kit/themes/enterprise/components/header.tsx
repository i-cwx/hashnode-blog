...
export const Header = () => {
	...
	return (
		<header className="border-b bg-cwxnavy py-10 dark:border-neutral-800 dark:bg-neutral-900">
			<Container className="grid grid-cols-4 gap-5 px-5">
				...
				<div className="col-span-2 flex flex-row items-center justify-end gap-5 text-slate-300 lg:col-span-3">
					...
					<Button href="https://discord.gg/cyberwoxacademy" as="a" type="primary" label="Join The Community" />
				</div>
			</Container>
